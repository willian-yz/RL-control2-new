...
def build_case5_configs() -> tuple[EnvConfig, RLConfig]:
    env_config = EnvConfig(
        ...
        workdir=r"D:\LYZ\A case 4 2D inlet change",
...
def main() -> None:
    ...
    model_path = manager.train(train_steps=250*20,load_model_path=r'D:\LYZ\A case 4 2D inlet change\artifacts\my_model_case7_step11500.zip')
